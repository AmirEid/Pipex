...
/*   Updated: 2024/01/19 14:54:30 by aeid             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static size_t	wordcount(char *str, char c)
{
	size_t	wordcount;
	size_t	i;
...
static size_t	wordlength(char *str, char c)
{
	size_t	i;
...
static char	**split(char *str, char c, char **s, size_t nowords)
{
	size_t	i;
	size_t	j;
